...
function createHostAgentAndIdentityFromSeed(
    seedPhrase,
    host = "http://127.0.0.1:4943", // this points to local replica
...
(async () => {
    ...
    const test_method = 'get_webhook_url';
    ...
    switch (test_method) {
        ...
        case 'set_webhook_url':
            ...
            console.log(await custodian.call('set_webhook_url', 'https://example.com'));
            break;
        default:
